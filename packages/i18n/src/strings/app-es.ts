...
export const appStringsSpanish: Record<AppStringsKeys, string | null> = {
    ...
    loginTagline: 'Donde las cosas pequeñas no se pierden.',
    loginTaglineSub: 'Un hogar más tranquilo para los tickets, comentarios y todo lo demás de tu equipo.',
    loginTerms: 'Al continuar, aceptas nuestros Términos y nuestra Política de Privacidad.',
